  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <div className="w-full bg-white px-4 md:px-[37px] py-4 md:py-8">
        ...
        {/* Our Mission Section */}
        <div className="relative w-full min-h-[400px] md:h-[483px] bg-[#6DBEDF] border border-[rgba(0,0,0,0.16)] rounded-[10px] mb-4 md:mb-8 flex flex-col-reverse md:flex-row">
          <div className="w-full md:w-[362px] h-[250px] md:h-[483px] rounded-[10px] overflow-hidden flex-shrink-0">
          ...
          <div className="flex-1 p-6 md:p-12 flex flex-col justify-center">
            ...
            <div className="text-white text-[16px] md:text-[33px] leading-normal text-justify" style={{ fontFamily: 'Inter, sans-serif' }}>
        ...
        {/* Our Vision Section */}
        <div className="relative w-full min-h-[400px] md:h-[483px] bg-[#38ABAE] border border-[rgba(0,0,0,0.16)] rounded-[10px] mb-4 md:mb-8 flex flex-col md:flex-row">
          <div className="flex-1 p-6 md:p-12">
            <h2 className="text-white font-extrabold text-[28px] md:text-[45px] mb-4 md:mb-8" style={{ fontFamily: 'Inter, sans-serif' }}>
              Our Vision
            </h2>
            <div className="text-white text-[16px] md:text-[31px] leading-normal text-justify space-y-2 md:space-y-4" style={{ fontFamily: 'Inter, sans-serif' }}>
        ...
        {/* Our Values Section */}
        <div className="relative w-full min-h-[400px] md:h-[483px] bg-[#78BE9F] border border-[rgba(0,0,0,0.16)] rounded-[10px] mb-4 md:mb-8 flex flex-col-reverse md:flex-row">
          <div className="w-full md:w-[362px] h-[250px] md:h-[483px] rounded-[10px] overflow-hidden flex-shrink-0">
