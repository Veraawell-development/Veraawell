...
const { imageUpload, documentUpload, uploadProfileImage, deleteProfileImage, uploadDoctorDocuments, uploadDoctorDocument, uploadArticleImage } = require('../controllers/upload.controller');
