/**
 * Migration script to populate Article collection with existing hardcoded articles
 * Run this once to migrate data from client/src/data/articles.ts to MongoDB
 * 
 * Usage: node server/scripts/migrateArticles.js
 */
...
// Hardcoded articles from client/src/data/articles.ts
const articles = [
    {
